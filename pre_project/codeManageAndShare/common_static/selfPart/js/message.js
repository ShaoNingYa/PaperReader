...
$(".clearMessageHistory").css({
    ...
    studyNumber = $(this).attr("id")
    // console.log($("#"+studyNumber).text())
    if (confirm("确定清空与"+$("#"+studyNumber).text()+"的聊天记录？")) {
        $.post("selfPart/messageClear",{"thatUserNumber":studyNumber},function(getClearResult){
            console.log(getClearResult)
            $("#"+studyNumber).click()
        })
    };
...
$(".mainShowBodyShowMessageStyle_CommunicateWindowTitle").mouseenter(function(){
    $(".clearMessageHistory").css({
        "display":"inline"
    })
}).mouseleave(function(){
