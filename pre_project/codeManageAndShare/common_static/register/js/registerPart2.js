...
function enterRegisterPart2() {
    ...
    $("#regSubmitPart2").click(function(){
        ...
        var selfInfoSet={
            ...
            "regTrueName":$("#regTrueName").val(),
            "sexChoice":$("#sexChoice").val(),
            "gradeChoice":$("#gradeChoice").val(),
            "classChoice":$("#classChoice").val(),
            "regStudyNumber":$("#regStudyNumber").val()
        };
        $.post("/register/infowrite",selfInfoSet,function(result){
            console.log("通过");
